...
typedef void *(*allocator_func)(void *allocator_data, allocator_type type,
                                usz size, usz alignment, void *old_memory,
                                usz old_size, allocator_flag flag);
...
void *allocator_malloc(allocator alloc, usz size,
                       usz alignment = DEFAULT_ALIGNMENT,
                       allocator_flag flag = allocator_flag_clear_to_zero);
void *allocator_realloc(allocator alloc, void *old_memory, usz old_size,
                        usz size, usz alignment = DEFAULT_ALIGNMENT,
                        allocator_flag flag = allocator_flag_clear_to_zero);
...
void *arena_allocator_func(void *allocator_data, allocator_type type, usz size,
                           usz alignment, void *old_memory, usz old_size,
                           allocator_flag flag);
void arena_init(arena_allocator *arena, void *backing_buffer,
                usz backing_buffer_length);
...
void stack_init(stack_allocator *s, void *backing_buffer,
                usz backing_buffer_length);
void *stack_allocator_func(void *allocator_data, allocator_type type, usz size,
                           usz alignment, void *old_memory, usz old_size,
                           allocator_flag flag);
...
void pool_init(pool_allocator *p, void *backing_buffer,
               usz backing_buffer_length, usz chunk_size, usz chunk_alignment);
void *pool_allocator_func(void *allocator_data, allocator_type type, usz size,
                          usz alignment, void *old_memory, usz old_size,
                          allocator_flag flag);
...
void *free_list_allocator_func(void *allocator_data, allocator_type type,
                               usz size, usz alignment, void *old_memory,
                               usz old_size, allocator_flag flag);
...
void *heap_allocator_func(void *allocator_data, allocator_type type, usz size,
                          usz alignment, void *old_memory, usz old_size,
                          allocator_flag flag);
inline void heap_init(heap_allocator *a) { a->head = NULL; }
